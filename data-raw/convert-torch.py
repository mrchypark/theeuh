...
class MyModel(nn.Module):
    def __init__(self):
        ...
        self.conv3 = nn.Conv1d(in_channels=100, out_channels=128, kernel_size=3)
        self.conv4 = nn.Conv1d(in_channels=100, out_channels=64, kernel_size=4)
        self.conv5 = nn.Conv1d(in_channels=100, out_channels=32, kernel_size=5)
