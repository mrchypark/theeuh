...
valid_version <- function(ver) {
  ver %in% list(
    # Legacy versions (may not be available on all platforms)
    ...
    # Currently available on PyPI (as of 2026-01)
    "1.15.0", "1.15.1", "1.16.0", "1.16.1", "1.16.2", "1.16.3",
    "1.17.0", "1.17.1", "1.17.3", "1.18.0", "1.18.1",
    "1.19.0", "1.19.2", "1.20.0", "1.20.1", "1.21.0", "1.21.1",
    "1.22.0", "1.22.1", "1.23.0", "1.23.1", "1.23.2"
  )
}
